    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-5 col-6 text-right m-b-30">
                <a href="{{route('admin.doctor.edit',$data->id)}}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        ...
                                        <li>
                                            <span class="title">Doctor's Reg Number :</span>
                                            <span class="text">{{$data->RegNumber}}</span>
                                        </li>
                                    ...
                                    <div class="experience-box">
                                                ...
                                                <label>Available Time  :</label>
                                                    ...
                                                    @foreach($dates as $date)
                                                            @foreach($data->dates as $ddate)
                                                                    @if($date->id == $ddate->id)
                                                                          <input type="button" class="btn btn-success btn-sm" value="{{$date->date}}">  
                                                                    @endif
                                                            @endforeach
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="button" name="fee"  value="{{$data->fee}}" class="btn btn-default"  required=""> TK
