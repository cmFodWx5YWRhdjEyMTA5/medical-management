...
@section('title',"Add Appointment Purpose")
...
@section('content')
    ...
    <div class="page-wrapper">
            <div class="content">
                ...
                <form action="{{route('admin.appointment-purpose.store')}}" method="post">
                	@csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                            	...
                            	<div class="form-group">
                                    ...
                                    <textarea name="description" id="editor1" class="form-control" rows="10"></textarea>
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-primary submit-btn" type="submit">SAVE PURPOSE</button>
                            </div>
